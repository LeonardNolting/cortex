...
export const DEFAULT_INVOICE_FILE_NAME = "{{formatName assignment.patientName includeTitles=false includeComma=false}} RG {{abbreviateCourt assignment.court}} {{printingDate}} {{timestamp}}";
